<template>
  <layout>
    <main role="main" class="termsAndConditions container">
      <header>
        <h1 class="termsAndConditions__title display-lg">Terms And Conditions</h1>
        <hr class="termsAndConditions__divider" />
      </header>
      ...
      <p>
        ...
        to it, still belong to Pawel Ozyzniewski.
      </p>

      <p>
        Pawel Ozyzniewski is committed to ensuring that the app is as useful and efficient as
      ...
      <p>
        The Veriffica app stores and processes personal data that you have provided to us, in order
        ...
        programs, compromise your phone’s security features and it could mean that the Veriffica app
      ...
      <p>
        You should be aware that there are certain things that Pawel Ozyzniewski will not take
        ...
        provider, but Pawel Ozyzniewski cannot take responsibility for the app not working at full
      ...
      <p>
        Along the same lines, Pawel Ozyzniewski cannot always take responsibility for the way you
        use the app i.e. You need to make sure that your device stays charged – if it runs out of
        battery and you can’t turn it on to avail the Service, Pawel Ozyzniewski cannot accept
        responsibility.
      </p>

      <p>
        With respect to Pawel Ozyzniewski’s responsibility for your use of the app, when you’re
        ...
        us so that we can make it available to you. Pawel Ozyzniewski accepts no liability for any
      ...
      <p>
        ...
        the app. Pawel Ozyzniewski does not promise that it will always update the app so that it is
      ...
      <p>These terms and conditions are effective as of 2021-07-25</p>

      <p><strong>Contact Us</strong></p>

      <p>
        If you have any questions or suggestions about my Terms and Conditions, do not hesitate to
        contact me at pozyzniewski@yahoo.com.
      </p>
...
export default {
  metaInfo: {
    ...
    description: "Terms And Conditions made special for the Verrifica mobile app"
  }
}
</script>

<template>
  <layout>
    <main role="main" class="privacyPolicy container">
      <header>
        <h1 class="privacyPolicy__title display-lg">Privacy Policy</h1>
        <hr class="privacyPolicy__divider" />
      </header>

      <p>
        Paul Ozyzniewski built the Veriffica app as an Ad Supported app. This SERVICE is provided by
        Paul Ozyzniewski at no cost and is intended for use as is.
      </p>
      ...
      <p>
        ...
        which is accessible at Veriffica unless otherwise defined in this Privacy Policy.
      </p>
      ...
      <p>
        ...
        veriffica@yahoo.com. The information that I request will be retained on your device and is

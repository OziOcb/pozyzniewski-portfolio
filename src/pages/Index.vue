<template>
  <Layout>
    ...
    <p>
      ...
      Aenean massa. Cum sociis natoque penatibus et m. Lorem ipsum dolor sit amet, consectetuer
      adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus
      et m. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget
      dolor. Aenean massa. Cum sociis natoque penatibus et m.
    </p>
    <p>
      Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor.
      Aenean massa. Cum sociis natoque penatibus et m. Lorem ipsum dolor sit amet, consectetuer
    ...
    <form>
      <fieldset>
        <legend>
          Inputs as descendents of labels (form legend). This doubles up as a long legend that can
          test word wrapping.
        </legend>
        <p>
          <label>
            ...
            <input
              type="text"
              value="default value that goes on and on without stopping or punctuation"
            />
          </label>
        </p>
        <p>
      ...
      <fieldset>
        ...
        <p>
          <label for="irb">Radio input</label>
          <input id="irb" type="radio" name="rad" />
        </p>
        <p>
          <label for="icb">Checkbox input</label>
          <input id="icb" type="checkbox" />
        </p>
        <p>
          <input id="irb2" type="radio" name="rad" />
          <label for="irb2">Radio input</label>
        </p>
        <p>
          <input id="icb2" type="checkbox" />
          <label for="icb2">Checkbox input</label>
        </p>

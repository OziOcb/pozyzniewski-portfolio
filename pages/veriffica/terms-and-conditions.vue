<template>
  <main role="main" class="termsAndConditions container">
    ...
    <p>
      ...
      intellectual property rights related to it, still belong to Pawel
      Ozyzniewski.
    </p>

    <p>
      Pawel Ozyzniewski is committed to ensuring that the app is as useful and
    ...
    <p>
      The Veriffica app stores and processes personal data that you have
      ...
      features and it could mean that the Veriffica app won’t work properly or
      at all.
    </p>
    ...
    <p>
      You should be aware that there are certain things that Pawel Ozyzniewski
      ...
      be Wi-Fi, or provided by your mobile network provider, but Pawel
      Ozyzniewski cannot take responsibility for the app not working at full
    ...
    <p>
      Along the same lines, Pawel Ozyzniewski cannot always take responsibility
      ...
      avail the Service, Pawel Ozyzniewski cannot accept responsibility.
    </p>

    <p>
      With respect to Pawel Ozyzniewski’s responsibility for your use of the
      ...
      can make it available to you. Pawel Ozyzniewski accepts no liability for
    ...
    <p>
      ...
      Pawel Ozyzniewski does not promise that it will always update the app so
      that it is relevant to you and/or works with the iOS version that you have
    ...
    <p>
      ...
      not hesitate to contact me at pozyzniewski@yahoo.com.
    </p>
